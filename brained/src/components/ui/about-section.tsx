                ...
                <div className="relative">
                    ...
                    >
                        ...
                        >
                            ...
                            <image
                                ...
                                width={"100%"}
                                height={"100%"}
                                xlinkHref="https://images.unsplash.com/photo-1481437156560-3205f6a55735?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=80&w=1195"
                            ></image>
                        </svg>
                    </TimelineContent>
                    ...
                    <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
                                <span className="text-orange-500 font-bold">10,000+</span>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            >
                                <p className="leading-relaxed text-justify">
                                    Founded with a passion for quality and customer satisfaction, ShopEase
                                    has grown from a small startup into a leading e-commerce platform. We
                                    curate the finest products across fashion, electronics, and lifestyle
                                    categories to bring you the best shopping experience.
                                </p>
                            </TimelineContent>
                            <TimelineContent
                                as="div"
                            ...
                            >
                                <p className="leading-relaxed text-justify">
                                    Our commitment goes beyond just selling products. We believe in building
                                    lasting relationships with our customers through exceptional service,
                                    competitive prices, and a seamless shopping experience from browse to delivery.
                                </p>
                            </TimelineContent>
                        </TimelineContent>
                    </div>
                    ...
                    <div className="md:col-span-1">
                        <div className="text-right">
                            ...
                            >
                                E-Commerce Excellence | Quality Products
                            </TimelineContent>
                            ...
                            >
                                <p className="text-gray-900 font-medium mb-4">
                                    Ready to discover amazing products and unbeatable deals?
                                </p>
                            </TimelineContent>
